...
-- Convolution Layers
model:add(cudnn.SpatialConvolution(3, 256, 5, 5, 1, 1, 2, 2))
...
model:add(cudnn.SpatialConvolution(256, 512, 4, 4, 1, 1))
model:add(cudnn.ReLU())
--model:add(nn.Dropout(0.5))

model:add(cudnn.SpatialConvolution(512, 10, 1, 1, 1, 1))
--model:add(cudnn.ReLU())
